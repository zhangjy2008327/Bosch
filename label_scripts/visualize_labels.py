...
from label_scripts.spline_creator import SplineCreator
from label_scripts import label_file_scripts
from label_scripts import dataset_constants as dc
...
def create_segmentation_image(json_path, color=None, image=None):
    ...
    for lane in label['lanes']:
        ...
        for marker in lane['markers']:
            ...
            label_file_scripts.project_lane_marker(p1, p2, width=.1, projection_matrix=label['projection_matrix'],
